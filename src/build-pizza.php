...
<body>
    <!-- Navigation (using proper navbar from style.css) -->
    <nav class="navbar">
        <div class="nav-container">
            <div class="nav-brand">
                <i class="fas fa-pizza-slice"></i>
                <a href="index.php" style="text-decoration: none; color: inherit;">Crust Pizza</a>
            </div>
            <div class="nav-menu">
            ...
            <div style="display: grid; grid-template-columns: 1fr 350px; gap: 2rem; margin-top: 2rem;" class="pizza-builder">
                ...
                <div class="builder-steps">
                            ...
                            <div class="ingredient-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                                <?php foreach ($ingredients['crust'] as $crust): ?>
                                    <label class="ingredient-option" style="display: flex; align-items: center; padding: 1rem; border: 2px solid #ddd; border-radius: 8px; cursor: pointer;">
                                        <input type="radio" name="crust" value="<?php echo $crust['ingredient_id']; ?>"
                                            data-price="<?php echo $crust['price']; ?>"
                                            data-name="<?php echo htmlspecialchars($crust['name']); ?>"
                                            <?php echo $crust['name'] === 'Classic Crust' ? 'checked' : ''; ?>
                        ...
                        <div class="card-body">
                            <div class="ingredient-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                                <?php foreach ($ingredients['sauce'] as $sauce): ?>
                                    <label class="ingredient-option" style="display: flex; align-items: center; padding: 1rem; border: 2px solid #ddd; border-radius: 8px; cursor: pointer;">
                                        <input type="radio" name="sauce" value="<?php echo $sauce['ingredient_id']; ?>"
                                            data-price="<?php echo $sauce['price']; ?>"
                                            data-name="<?php echo htmlspecialchars($sauce['name']); ?>"
                                            <?php echo $sauce['name'] === 'Tomato Base' ? 'checked' : ''; ?>
                                            style="margin-right: 0.5rem;">
                                        <div style="flex: 1;">
                        ...
                        <div class="card-body">
                            <div class="ingredient-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                                <?php foreach ($ingredients['cheese'] as $cheese): ?>
                                    <label class="ingredient-option" style="display: flex; align-items: center; padding: 1rem; border: 2px solid #ddd; border-radius: 8px; cursor: pointer;">
                                        <input type="radio" name="cheese" value="<?php echo $cheese['ingredient_id']; ?>"
                                            data-price="<?php echo $cheese['price']; ?>"
                                            data-name="<?php echo htmlspecialchars($cheese['name']); ?>"
                                            <?php echo $cheese['name'] === 'Mozzarella' ? 'checked' : ''; ?>
                                            style="margin-right: 0.5rem;">
                                        <div style="flex: 1;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="ingredient-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; margin-bottom: 2rem;">
                                <?php foreach ($ingredients['meat'] as $meat): ?>
                                    <label class="ingredient-option" style="display: flex; align-items: center; padding: 1rem; border: 2px solid #ddd; border-radius: 8px; cursor: pointer;">
                                        <input type="checkbox" name="toppings[]" value="<?php echo $meat['ingredient_id']; ?>"
                                            data-price="<?php echo $meat['price']; ?>"
                                            data-name="<?php echo htmlspecialchars($meat['name']); ?>"
                                            style="margin-right: 0.5rem;">
                                        <div style="flex: 1;">
                            ...
                            <div class="ingredient-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                                <?php foreach ($ingredients['vegetable'] as $vegetable): ?>
                                    <label class="ingredient-option" style="display: flex; align-items: center; padding: 1rem; border: 2px solid #ddd; border-radius: 8px; cursor: pointer;">
                                        <input type="checkbox" name="toppings[]" value="<?php echo $vegetable['ingredient_id']; ?>"
                                            data-price="<?php echo $vegetable['price']; ?>"
                                            data-name="<?php echo htmlspecialchars($vegetable['name']); ?>"
                                            style="margin-right: 0.5rem;">
                                        <div style="flex: 1;">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <textarea id="specialInstructions" placeholder="Any special requests for your pizza?"
    ...
    <script>
        ...
        function addCustomPizzaToCart() {
            ...
            if (!selectedSize || !selectedCrust || !selectedSauce || !selectedCheese) {
                showAlert('Please complete all pizza selections', 'warning');
                return;
            }
        ...
        // Add step number styling and cart count styling
