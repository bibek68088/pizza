...
if (!isset($_GET['token'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['reset_password'])) {
        if (!validateCSRFToken($_POST['csrf_token'])) {
        ...
        } elseif (!checkRateLimit('reset_password')) {
            ...
            if (empty($password) || empty($confirm_password)) {
                ...
                $user_id = $user->validateResetToken($token);
                if ($user_id) {
                    if ($user->updatePassword($user_id, $password)) {
                        $user->deleteResetToken($token);
                        $success = 'Password reset successfully. <a href="login.php">Log in</a>.';
                        logActivity('password_reset_complete', "Reset password for user ID: $user_id", $user_id);
                    } else {
...
<head>
    ...
    <title>Reset Password - Crust Pizza</title>
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                ...
                <p>Enter your new password for your Crust Pizza account</p>
            </div>
