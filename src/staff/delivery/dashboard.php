        ...
        <?php else: ?>
            <?php foreach ($preparedOrders as $order): ?>
                <div class="order-card">
                    ...
                    <p><strong>Delivery Instructions:</strong> <?php echo htmlspecialchars($order['delivery_instructions'] ?? 'None'); ?></p>
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" name="update_status" class="btn-primary">Mark as Out for Delivery</button>
                    </form>
                </div>
            <?php endforeach; ?>
        <?php endif; ?>
            ...
            <?php foreach ($deliveryOrders as $order): ?>
                <div class="order-card">
                    ...
                    <form method="POST">
                        ...
                        <input type="hidden" name="order_id" value="<?php echo $order['order_id']; ?>">
                        <div class="btn-group">
                            <button type="submit" name="update_status" value="delivered" class="btn-primary">Mark as Delivered</button>
                            <button type="submit" name="update_status" value="delivery_failure" class="btn-primary">Mark as Delivery Failure</button>
                        </div>
                    </form>
                </div>
            <?php endforeach; ?>
